...
public class OfcListController implements Initializable{
	...
	public ListView<BorderPane> getList(int page) {
		...
		for(int j=1; j<=5; j++) {
			...
			try {
				...
				Image image = new Image(getClass().getResource("../imagesOfc/OFC/"+number+".jpg").toString());
